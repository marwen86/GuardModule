...
public protocol NetworkService {
    ...
    @discardableResult
    func directRequest(endpoint: URL, completion: @escaping CompletionHandler) -> NetworkCancellable?
    @discardableResult
...
extension DefaultNetworkService: NetworkService {
    ...
    public func directRequest(endpoint: URL, completion: @escaping CompletionHandler) -> NetworkCancellable? {
